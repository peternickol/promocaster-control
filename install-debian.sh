...
touch "$DATA_DIR/gitconfig"
chown "$SERVICE_USER:$SERVICE_USER" "$DATA_DIR/gitconfig"
chmod 0640 "$DATA_DIR/gitconfig"
...
PROMOCASTER_CONTROL_GIT_CONFIG=$DATA_DIR/gitconfig
